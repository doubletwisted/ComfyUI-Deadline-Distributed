...
class DeadlineJobSubmitter:
    ...
    def _create_job_info_file(self, job_info_file: str):
        ...
        with open(job_info_file, 'w') as f:
            ...
            # Add environment variables for distributed mode
            if config.get('launch_as_distributed', False):
                f.write(f"EnvironmentKeyValue0=DEADLINE_DIST_MODE=1\n")
                f.write(f"EnvironmentKeyValue1=COMFY_MASTER_WS={config.get('master_ws_address', 'localhost:8188')}\n")
...
class DeadlineSubmitNode:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            ...
            "optional": {
                ...
                "launch_as_distributed": ("BOOLEAN", {
                    "default": False,
                    "label_on": "Launch as Distributed Workers",
                    "label_off": "Normal Batch Render"
                }),
                "master_ws_address": ("STRING", {
                    "default": "localhost:8188",
                    "multiline": False,
                    "placeholder": "Master ComfyUI WebSocket address (e.g., 192.168.1.100:8188)"
                }),
            },
            "hidden": {
                "prompt": "PROMPT",
    ...
    def submit_to_deadline(self, workflow_file, auto_detect_workflow, batch_count, chunk_size, 
                         ...
                         launch_as_distributed=False, master_ws_address="localhost:8188",
        ...
        try:
            ...
            # Modify job name for distributed mode
            final_job_name = f"[DIST] {job_name}" if launch_as_distributed else job_name
            
            # Create job configuration
            job_config = self._create_job_config(
                final_job_name, priority, pool, group, batch_count, chunk_size,
                change_seeds_per_task, output_directory, comment, department,
                launch_as_distributed, master_ws_address
            )
    ...
    def _create_job_config(self, job_name: str, priority: int, pool: str, group: str, 
                          ...
                          output_directory: str, comment: str, department: str,
                          launch_as_distributed: bool = False, master_ws_address: str = "localhost:8188") -> Dict:
        ...
        return {
            ...
            'launch_as_distributed': launch_as_distributed,
            'master_ws_address': master_ws_address
        }
